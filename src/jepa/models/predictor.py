...
from jepa.utils.tensors import repeat_interleave_batch, trunc_normal_
...
class VisionTransformerPredictor(nn.Module):
    ...
    def forward(self, x, masks_x, masks_y, mod="video", mask_index=1):
        ...
        if self.mask_tokens is None or self.num_mask_tokens < 1:
            raise ValueError(
                "Predictor requires mask tokens. Set use_mask_tokens=True."
            )
